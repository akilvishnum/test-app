...
export const ResponseContainer = () => {
    ...
    return (
        <Box sx = {{width: '65%', minHeight: '90%', background: 'transparent', borderRadius: '20px', border: '1px solid #c2c2c2de'}}>
            <Box sx = {{position: 'sticky', top: 0, background: 'white', width: '100%', borderRadius: '20px 20px 0px 0px'}}>
            ...
            <Box sx = {{position: 'sticky', width: '100%', bottom: 0, display: 'flex', zIndex: 100,  padding: '0.77rem 0.5rem', boxSizing: 'border-box', borderTop: '1px solid #c2c2c2de', background: 'white', borderRadius: '0 0 20px 20px'}}>
